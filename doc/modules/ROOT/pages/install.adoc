...
1. Download a precompiled copy of *Skybrush Studio Server* from your [Skybrush account](https://account.skybrush.io).
2. Run your server instance to get the hardware ID of your machine. It will be displayed in the terminal log of the server.
3. Use this hardware ID for activating your license in the [Skybrush Store](https://shop.skybrush.io).
