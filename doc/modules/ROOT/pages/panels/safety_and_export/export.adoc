...
Frame range:: Define the frame range of the output (Render / Preview / Storyboard)
Trajectory FPS:: Set output frame rate for drone trajectories (make sure it is a submultiple of your render FPS)
Lights FPS:: Set the output frame rate for light programs (make sure it is a submultiple of your render FPS)
