...
Export terrain:: Enable this checkbox to export any Blender objects under the persistent "Terrain" scene collection to be embedded into the .skyc file (to be used by Skybrush Viewer).
