...
Custom expression:: A Python function which returns a number between 0 and 1. The function is called for each drone and each frame of the light effect. An example:
+
```python
