...
IMPORTANT: Make sure to append your empty formation to the storyboard before generating markers into it! This ensures that the start end end frames of the the imported animation and its color animation will be set up properly.
