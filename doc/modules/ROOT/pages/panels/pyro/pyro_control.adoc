...
Info:: With this option, drones will be highlighted with the same markers as in the
...
This options defines the size of the pyro overlay markers if the visualization type 
...
Duration:: This parameter defines the length of the pyro visualization. It does not affect the trigger event itself.
...
Yaw:: Defines the yaw angle of the pyro payload relative to the body frame of the drone, in degrees.
(0° points towards the yaw of the drone, 90° to the right, -90° to the left etc.)

Pitch:: Defines the pitch angle of the pyro payload relative to the body frame of the drone, in degrees.
