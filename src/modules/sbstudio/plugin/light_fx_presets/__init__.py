...
def odd_even_pulse(frame, time_fraction, drone_index, formation_index, position, drone_count):
...
def odd_even_constant(frame, time_fraction, drone_index, formation_index, position, drone_count):
    is_odd = (formation_index or 0) % 2
...
def simple_filling(frame, time_fraction, drone_index, formation_index, position, drone_count):
    if not drone_count:
        return 0.0
...
def clover_fill(frame, time_fraction, drone_index, formation_index, position, drone_count):
...
def continuous_filling_1(frame, time_fraction, drone_index, formation_index, position, drone_count):
...
def continuous_filling_1_5(frame, time_fraction, drone_index, formation_index, position, drone_count):
...
def continuous_filling_2(frame, time_fraction, drone_index, formation_index, position, drone_count):
...
def continuous_filling_3(frame, time_fraction, drone_index, formation_index, position, drone_count):
...
def continuous_filling_4(frame, time_fraction, drone_index, formation_index, position, drone_count):
...
def continuous_filling_5(frame, time_fraction, drone_index, formation_index, position, drone_count):
...
def continuous_filling_stripes(frame, time_fraction, drone_index, formation_index, position, drone_count):
...
def ramp_down_wave(frame, time_fraction, drone_index, formation_index, position, drone_count):
    wave_length = 50
...
def ramp_up_wave_10(frame, time_fraction, drone_index, formation_index, position, drone_count):
...
def ramp_up_wave_15(frame, time_fraction, drone_index, formation_index, position, drone_count):
...
def ramp_up_wave_25(frame, time_fraction, drone_index, formation_index, position, drone_count):
...
def ramp_up_wave_75(frame, time_fraction, drone_index, formation_index, position, drone_count):
...
def ramp_up_wave_100(frame, time_fraction, drone_index, formation_index, position, drone_count):
...
def ramp_up_wave_150(frame, time_fraction, drone_index, formation_index, position, drone_count):
...
def triangle_wave(frame, time_fraction, drone_index, formation_index, position, drone_count):
    wave_length = 50
...
def expanding_pulse(frame, time_fraction, drone_index, formation_index, position, drone_count):
    fi = formation_index or 0
...
def wave_effect(frame, time_fraction, drone_index, formation_index, position, drone_count):
    speed = 0.1
...
def group_ranges_3(frame, time_fraction, drone_index, formation_index, position, drone_count):
    ranges = [
        (0, 17, 0.1),
        (18, 35, 0.2),
        (36, 53, 0.4),
...
def group_ranges_5(frame, time_fraction, drone_index, formation_index, position, drone_count):
    ranges = [
        (0, 19, 0.2),
        (20, 39, 0.1),
        (36, 53, 0.4),
...
def lightfx_0(frame, time_fraction, drone_index, formation_index, position, drone_count):
    if not drone_count:
        return 0.0
    speed_factor = 1.0
...
def lightfx_1(frame, time_fraction, drone_index, formation_index, position, drone_count):
    if not drone_count:
        return 0.0
    speed_factor = 1.0
...
def lightfx_4(frame, time_fraction, drone_index, formation_index, position, drone_count):
    is_odd = (formation_index or 0) % 2
...
def lightfx_6(frame, time_fraction, drone_index, formation_index, position, drone_count):
    wave_length = 50
    return (frame + (formation_index or 0)) % wave_length / wave_length
...
def lightfx_7(frame, time_fraction, drone_index, formation_index, position, drone_count):
    wave_length = 400
    offset = (frame + (formation_index or 0)) % wave_length / wave_length
    return 1 - abs(2 * offset - 1)
...
def lightfx_8(frame, time_fraction, drone_index, formation_index, position, drone_count):
    if not drone_count:
        return 0.0
    speed_factor = -0.2
...
def radial_diffusion_xy(frame, time_fraction, drone_index, formation_index, position, drone_count):
...
def radial_diffusion_xz(frame, time_fraction, drone_index, formation_index, position, drone_count):
...
def radial_diffusion_yz(frame, time_fraction, drone_index, formation_index, position, drone_count):
...
def radial_convergence_xy(frame, time_fraction, drone_index, formation_index, position, drone_count):
    distance = _v51_get_plane_distance(position, 'XY')
    return (math.sin(frame * _V51_RADIAL_SPEED + distance * _V51_RADIAL_WAVE_K) + 1) / 2
...
def radial_convergence_xz(frame, time_fraction, drone_index, formation_index, position, drone_count):
    distance = _v51_get_plane_distance(position, 'XZ')
    return (math.sin(frame * _V51_RADIAL_SPEED + distance * _V51_RADIAL_WAVE_K) + 1) / 2
...
def radial_convergence_yz(frame, time_fraction, drone_index, formation_index, position, drone_count):
    distance = _v51_get_plane_distance(position, 'YZ')
    return (math.sin(frame * _V51_RADIAL_SPEED + distance * _V51_RADIAL_WAVE_K) + 1) / 2
...
def roundtrip_sweep_ltr_xy(frame, time_fraction, drone_index, formation_index, position, drone_count):
...
def roundtrip_sweep_rtl_xy(frame, time_fraction, drone_index, formation_index, position, drone_count):
    coord = _v51_get_axis_coord(position, 'X')
    return _v51_gradient_sweep_roundtrip(coord, -1, frame)
...
def roundtrip_sweep_ltr_xz(frame, time_fraction, drone_index, formation_index, position, drone_count):
    coord = _v51_get_axis_coord(position, 'X')
    return _v51_gradient_sweep_roundtrip(coord, +1, frame)
...
def roundtrip_sweep_rtl_xz(frame, time_fraction, drone_index, formation_index, position, drone_count):
    coord = _v51_get_axis_coord(position, 'X')
    return _v51_gradient_sweep_roundtrip(coord, -1, frame)
...
def roundtrip_sweep_ltr_yz(frame, time_fraction, drone_index, formation_index, position, drone_count):
...
def roundtrip_sweep_rtl_yz(frame, time_fraction, drone_index, formation_index, position, drone_count):
    coord = _v51_get_axis_coord(position, 'Y')
    return _v51_gradient_sweep_roundtrip(coord, -1, frame)
...
def oneway_sweep_ltr_xy(frame, time_fraction, drone_index, formation_index, position, drone_count):
    coord = _v51_get_axis_coord(position, 'X')
...
def oneway_sweep_rtl_xy(frame, time_fraction, drone_index, formation_index, position, drone_count):
    coord = _v51_get_axis_coord(position, 'X')
    return _v51_gradient_sweep_oneway_loop(coord, -1, frame)
...
def oneway_sweep_ltr_xz(frame, time_fraction, drone_index, formation_index, position, drone_count):
    coord = _v51_get_axis_coord(position, 'X')
    return _v51_gradient_sweep_oneway_loop(coord, +1, frame)
...
def oneway_sweep_rtl_xz(frame, time_fraction, drone_index, formation_index, position, drone_count):
    coord = _v51_get_axis_coord(position, 'X')
    return _v51_gradient_sweep_oneway_loop(coord, -1, frame)
...
def oneway_sweep_ltr_yz(frame, time_fraction, drone_index, formation_index, position, drone_count):
    coord = _v51_get_axis_coord(position, 'Y')
    return _v51_gradient_sweep_oneway_loop(coord, +1, frame)
...
def oneway_sweep_rtl_yz(frame, time_fraction, drone_index, formation_index, position, drone_count):
    coord = _v51_get_axis_coord(position, 'Y')
    return _v51_gradient_sweep_oneway_loop(coord, -1, frame)
...
def diagonal_sweep_lb_rt_xy(frame, time_fraction, drone_index, formation_index, position, drone_count):
...
def diagonal_sweep_rt_lb_xy(frame, time_fraction, drone_index, formation_index, position, drone_count):
    pos_a = _v51_get_axis_coord(position, 'X')
    pos_b = _v51_get_axis_coord(position, 'Y')
    return _v51_gradient_sweep_diagonal(pos_a, pos_b, -1, frame)
...
def diagonal_sweep_lb_rt_xz(frame, time_fraction, drone_index, formation_index, position, drone_count):
    pos_a = _v51_get_axis_coord(position, 'X')
...
def diagonal_sweep_rt_lb_xz(frame, time_fraction, drone_index, formation_index, position, drone_count):
    pos_a = _v51_get_axis_coord(position, 'X')
    pos_b = _v51_get_axis_coord(position, 'Z')
    return _v51_gradient_sweep_diagonal(pos_a, pos_b, -1, frame)
...
def diagonal_sweep_lb_rt_yz(frame, time_fraction, drone_index, formation_index, position, drone_count):
...
def diagonal_sweep_rt_lb_yz(frame, time_fraction, drone_index, formation_index, position, drone_count):
    pos_a = _v51_get_axis_coord(position, 'Y')
    pos_b = _v51_get_axis_coord(position, 'Z')
    return _v51_gradient_sweep_diagonal(pos_a, pos_b, -1, frame)
...
def chasing_tails_xy(frame, time_fraction, drone_index, formation_index, position, drone_count):
...
def chasing_tails_xz(frame, time_fraction, drone_index, formation_index, position, drone_count):
...
def chasing_tails_yz(frame, time_fraction, drone_index, formation_index, position, drone_count):
...
def radar_scan_60_xy(frame, time_fraction, drone_index, formation_index, position, drone_count):
...
def radar_scan_90_xy(frame, time_fraction, drone_index, formation_index, position, drone_count):
...
def radar_scan_120_xy(frame, time_fraction, drone_index, formation_index, position, drone_count):
...
def radar_scan_60_xz(frame, time_fraction, drone_index, formation_index, position, drone_count):
...
def radar_scan_90_xz(frame, time_fraction, drone_index, formation_index, position, drone_count):
...
def radar_scan_120_xz(frame, time_fraction, drone_index, formation_index, position, drone_count):
...
def radar_scan_60_yz(frame, time_fraction, drone_index, formation_index, position, drone_count):
...
def radar_scan_90_yz(frame, time_fraction, drone_index, formation_index, position, drone_count):
...
def radar_scan_120_yz(frame, time_fraction, drone_index, formation_index, position, drone_count):
...
def pattern_paint_on_xy(frame, time_fraction, drone_index, formation_index, position, drone_count):
...
def _v51_gradient_sweep_roundtrip(coord: float, direction: int, frame: int):
    ...
    if t < oneway_frames:
        ...
        phase = 0.0
    sweep_pos = _V51_SWEEP_RANGE_MIN + phase * (_V51_SWEEP_RANGE_MAX - _V51_SWEEP_RANGE_MIN)
    if direction < 0:
...
def _v51_gradient_sweep_oneway_loop(coord: float, direction: int, frame: int):
    ...
    if direction > 0:
        ...
        sweep_pos = _V51_SWEEP_RANGE_MAX - phase * (_V51_SWEEP_RANGE_MAX - _V51_SWEEP_RANGE_MIN)
    dist = abs(coord - sweep_pos)
    half_width = _V51_SWEEP_GRADIENT_WIDTH / 2.0
    if dist >= half_width:
        return 0.0
...
def _v51_gradient_sweep_diagonal(pos_a: float, pos_b: float, direction: int, frame: int):
...
def _build_enum_items() -> list[tuple[str, str, str]]:
    ...
    for i, (preset_id, meta) in enumerate(reversed_presets):
