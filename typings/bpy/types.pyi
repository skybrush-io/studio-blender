...
class bpy_prop_collection(Sequence[T]):
    ...
    @overload
    def foreach_get(self, attr: str, seq: MutableSequence[float]) -> None: ...
    @overload
...
OperatorReturnItems = set[
    Literal["FINISHED", "CANCELLED", "RUNNING_MODAL", "PASS_THROUGH"]
]
...
class Operator(bpy_struct):
    ...
    def cancelled(self, context: Context) -> bool: ...
    def check(self, context: Context) -> bool: ...
    def draw(self, context: Context) -> None: ...
    def execute(self, context: Context) -> OperatorReturnItems: ...
    def invoke(self, context: Context, event) -> OperatorReturnItems: ...
    def modal(self, context: Context, event) -> OperatorReturnItems: ...
    def report(
        self,
        type: set[
            Literal[
